...
<!----------------- 네비게이션  끝------------------------>
	...
	<div id="wrap">
		<form action="BBLEditProcess.jsp" method="post" enctype="multipart/form-data">
		
			<input type="hidden" name="mainpageId" value="<%= mainpageId %>">
			
			<div class="input-group" id="titlebar">
			    <span class="input-group-addon">타이틀</span>
			    <input id="msg" type="text" class="form-control" name="mainpage_Title" placeholder="제목을 입력해 주세요." value="<%= mainpage.getMainpage_Title() %>">
			</div>
			...
			<div class="form-group">
			    ...
			    <textarea class="form-control" rows="20" id="comment" name="mainpage_Content" placeholder="내용을 입력해 주세요."><% if(mainpage.getMainpage_Content()!=null){out.print(mainpage.getMainpage_Content());} %></textarea>
			</div>
