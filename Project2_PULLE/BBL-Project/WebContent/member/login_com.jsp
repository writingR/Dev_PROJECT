		...
		<div class=col-lg-4>
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="com_loginProcess.jsp">
					<h3 style="text-align:center;font-family: 'Sunflower', sans-serif;">사업자 로그인</h3>
					...
					<div class="form-group">   
						...
						<input type="reset" class="btn btn-primary form-control" value="취소" style="margin:5px; margin-left:-1px;">
