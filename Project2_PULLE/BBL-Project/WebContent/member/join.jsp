			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data == 'Y') {
						...
						$('#idchkMsg').css('color','#84817a').css('font-weight','bold');
					} else {
				...
				$.ajax({
					...
					success : function(data) {
						...
						if (data == 'Y') {
							...
							$('#idchkMsg1').css('color','#84817a').css('font-weight','bold');
						} else {
							/* alert("사용할 수 없습니다.") */
							//$('body').append('<span style="color:red;">INVALID ID.</span>')
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data == 'Y') {
						...
						$('#idchkMsg2').css('color','#84817a').css('font-weight','bold');
					} else {
						/* alert("비밀번호가 다릅니다.") */
						//$('body').append('<span style="color:red;">INVALID ID.</span>')
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data == 'Y') {
						...
						$('#idchkMsg3').css('color','#84817a').css('font-weight','bold');
					} else {
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data == 'Y') {
						...
						$('#idchkMsg4').css('color','#84817a').css('font-weight','bold');
					} else {
			...
			$.ajax({
				...
				success : function(data) {
					...
					if (data == 'Y') {
						...
						$('#idchkMsg5').css('color','#84817a').css('font-weight','bold');
					} else {
						/* alert("메일 인증에 실패했습니다.") */
						//$('body').append('<span style="color:red;">INVALID ID.</span>')
